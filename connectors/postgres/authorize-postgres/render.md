...
<figure><img src="../../../.gitbook/assets/image (18).png" alt="Screenshot of the Render database connections section with the external database URL"><figcaption><p>External Database URL</p></figcaption></figure>

In the Whalesync Postgres connection dialog, paste in the connection URI:

<figure><img src="../../../.gitbook/assets/image (12).png" alt="Screenshot of the Whalesync Postgres connection dialog"><figcaption><p>Enter your Postgres connection URI into Whalesync</p></figcaption></figure>
