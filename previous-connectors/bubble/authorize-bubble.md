...
<figure><img src="../../.gitbook/assets/image (21).png" alt="Screenshot of the Bubble API settings page with the &#x22;Use field display instead of ID for key names&#x22; option unchecked"><figcaption><p>Please uncheck "Use field display instead of ID for key names"</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (20).png" alt="Screenshot of the Bubble API settings page with the API key"><figcaption><p>API key</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (15).png" alt="Screenshot of the Bubble API settings page with the API URL"><figcaption><p>Data API root URL</p></figcaption></figure>
